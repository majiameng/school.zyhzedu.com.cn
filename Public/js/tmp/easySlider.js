    ...
    $.extend( Plugin.prototype, {
        ...
        positionPagination: function() {
           ...
           /* $(this.settings.paginationClass).css("margin-left", marginLeft);*/
            /*$(this.settings.paginationClass).css("top", "50%");*/
        ...
        positionControls: function() {
            ...
            /*$(this.settings.controlsClass + " " + "li").css("top", "50%");*/
      ...
      function resize() {
            ...
            var windowWidth = $(window).width();
             ...
             /*$('#main_ad > .carousel-inner > .item').each(function(i, item) {*/
                 $('#slider .slider > li').each(function(i, item) {

                   var $item = $(item);
                   // var imgSrc = $item.data(isSmallScreen ? 'image-xs' : 'image-lg');
                   var imgSrc =
                         isSmallScreen ? $item.data('image-xs') : $item.data('src');
