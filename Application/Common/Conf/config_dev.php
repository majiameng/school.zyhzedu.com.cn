...
return array(
	...
	'DB_NAME'   => 'zpceshi_zyhzedu', // 数据库名
	'DB_USER'   => 'zpceshi_zyhzedu', // 用户名
	'DB_PWD'    => 'Ts7dz5K2R4fah574', // 密码
	// 'DB_PWD'    => 'GS856cAEaR', // 密码
	'DB_PORT'   => '3306', // 端口
	'DB_TYPE'   => 'mysql', // 数据库类型
    ...
    'SITE_NAME'   =>  '石家庄工程职业学院聘用制员工招聘报名系统',
    'SITE_KEYWORDS'   =>  '石家庄工程职业学院聘用制员工招聘报名系统',
    'SITE_DESCRIPTION'   =>  '石家庄工程职业学院聘用制员工招聘报名系统',
    ...
    'MAIL_FROMNAME'		=>'石家庄工程职业学院聘用制员工招聘报名系统',//发件人姓名
...
//	'REDIS_AUTH'			=>'wending123a@ABC',//AUTH认证密码
	'REDIS_AUTH'			=>'tinymeng',//AUTH认证密码
  	'REDIS_PREF' 			=> 'zpcs:', //redis 前缀
